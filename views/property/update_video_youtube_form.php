...
<p style=""><i><span style='color:red'>(Copy you tube video link and past in input box below and click submit)</span></i></p>        
    ...
    <form id="signupForm" method="post"  action="<?php echo site_url('property/update_video_youtube/'.$pro_id); ?>">
    <div class="col-md-12" id="firstStep" class="firstStep">
    

  <div class="col-xs-6 form-group">
            <label id="label">you tube video link:*</label>
           <input type="text" class="form-control" style="width:400px" id="video_link" value="<?php echo $get_video_link_youtube[0]['link'];?>" name="video_link" placeholder="Enter you tube video link:"><?php echo form_error('phn_dev', '<div class="error" style="color:red;">', '</div>');?> 
        </div>
