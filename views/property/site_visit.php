...
<div class="tab-pane-active" id="receipt">
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example" width="100%">
    ...
    <tbody>
          ...
          <?php $i=1256;?>
            <?php foreach ($allmember_site_visit as $key): 
            ...
            ?>
                ...
                <!-- <a title="if you want to update property details, click it" href="<?php echo site_url('property/property_edit/'.$pro_id);?>" class="open-dialog-edit btn btn-info btn-rad" data-id=""><i class="icon-book"></i>Edit & View</a>
