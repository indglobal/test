...
$('body').on('focus',"#dob", function(){
  ...
  // });
    ...
    <form id="signupForm" method="post"  action="<?php echo site_url('property/addnew_photo/'); ?>" enctype="multipart/form-data">
    <div class="col-md-12" id="firstStep" class="firstStep">
    

    <legend style="font-size:15px; color:#3b5999; font-weight:700">Photo Slider » <small style="font-size:11px">use this panel to add photos which will be show in index page Recently Added plots section</small></legend>
