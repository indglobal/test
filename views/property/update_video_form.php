...
$('body').on('focus',"#dob", function(){
 ...
 <?php $str=$video_details->pro_video;
   $a=explode("/",$str);
   $video_name=$a[3];
 ?>
   <form role="form" method="post" enctype="multipart/form-data" action="<?php echo site_url('property/update_video/'.base64_encode($pro_id).'/'.$video_name);?>">
<br/>
    <legend style="font-size:15px; color:#3b5999; font-weight:700">Update Video » <small style="font-size:11px">if you want to update video for project ,choose file and submit ,it will reflect on project page.</small></legend>
