...
<form id="file_form" action="<?php echo site_url('property/property_images_upload'); ?>" method="post" enctype="multipart/form-data">
<legend style="font-size:15px; color:#3b5999; font-weight:700">Upload images » <small style="font-size:11px"> Use the below panel to upload images of a particular Property Under developer.</small></legend>
         ...
         <div class="col-xs-6 form-group">
            ...
            <input value="<?php  echo $pro_id;?>" class="form-control" title="Enter file number" autocomplete="off" type="text" name="pro_id"/>
        </div>
