	...
	<div class="FirstMainSection">
			<div class="container">
				<ol class="breadcrumb">
				  	...
				  	<li><a href="#"><?php echo getcityNameByID($getSpecific_developer_detail['0']['city_dev']);?></a></li>
				  	<li><a href="#"><?php echo $getSpecific_developer_detail['0']['dev_name'];?> </a></li>
									    			...
									    			<ul>
									    				<li>
															<div class='section half-left text-center'>
														        <h2><div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='<?php echo $getSpecific_developer_detail[0]['ongoing_pro'];?>' data-delay='10' data-increment="9"><h2><?php echo $getSpecific_developer_detail[0]['ongoing_pro'];?></h2></div></h2>
														    	<h4>ONGOING PROJECTS</h4>
														    </div>
									    				</li>
									    				<li class="Middlerightleftborder">
									    					<div class='section half-right text-center'>
														        <h2><div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='<?php echo $getSpecific_developer_detail[0]['upcoming_pro'];?>' data-delay='10' data-increment="9"><h2><?php echo $getSpecific_developer_detail[0]['upcoming_pro'];?></h2></div></h2>
														    	<h4>UPCOMING PROJECT</h4>
														    </div>
									    				</li>
									    				<li>
									    					<div class='section half-right text-center'>
														        <h2><div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='<?php echo $getSpecific_developer_detail[0]['completed_pro'];?>' data-delay='10' data-increment="9"><h2><?php echo $getSpecific_developer_detail[0]['completed_pro'];?></h2></div></h2>
...
<?php  }else{?>
 	    <button class="btn btn-joinGroup" data-toggle="modal" data-target="#joingroup_<?php echo $pro_id;?>" data-id=""><i class="fa fa-users"></i>Joi Group</button>
