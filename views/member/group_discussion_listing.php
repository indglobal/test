				...
				<div class="container">
					<div class="row">
						<div class="col-md-9 BannerText">
							<h2><?php echo $getproperty_details[0]['pro_name'];?> <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i></h2>
							<h4><?php echo $getproperty_details[0]['address_pro'];?></h4>
							<span class="badge BSR">Developer :  <?php echo getDevelopername($getproperty_details['0']['developer_id']);?></span>
						</div>
                 ...
                 <div class="form-group">
                    <label for="exampleInputPassword1">Topic</label>
                      <input type="text" class="form-control" name="topic"
                          id="topic" placeholder="Please Enter Topic"/>
                          <input type="hidden" class="form-control" name="pro_id" id="pro_id" value="<?php echo $pro_id;?>"
                          id="firstname" placeholder="Please Enter Topic"/>
                          <input type="hidden" class="form-control" name="user_id" value="<?php echo $userid;?>"
                          id="firstname" placeholder="Please Enter Topic"/>
                  </div>
                  
                 
                  <button type="submit_join_group" class="btn btn-primary" id="submit_topic">Submit</button>
...
<div class="tab-pane-active" id="receipt">
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="dataTables-example" width="100%">
    ...
    <tbody>
          ...
          ?>
            <?php foreach ($getAll_topic_by_proid as $topic): 
            ...
            ?>
                ...
                <td><a title="if you want to update topic, click here" href="<?php echo site_url('group_discussion/property_edit/'.$pro_id);?>" class="open-dialog-edit btn btn-info btn-rad" data-id=""><i class="icon-book"></i>Edit & View</a>
                    <a title="if you want to give comments, click here" href="<?php echo site_url('group_discussion/add_comment/'.$topic_id.'/'.$pro_id);?>" class="open-dialog-edit btn btn-success btn-rad" data-id=""><i class="icon-book"></i>Comment</a>
                </td>
                    <?php $i=$i+1; ?>
...
url: "<?php echo base_url(); ?>" + "index.php/group_discussion/add_topic",// Url to which the request is send
...
success: function(data)   // A function to be called if request succeeds
{
 if (data=="ok")
   { 
   //alert("okkk");
   //window.location.href ='<?php echo base_url();?>group_discussion/listed_topic/'+pro_id;
