...
<div class="banner-about">
	<div class="container">
		<div class="banner-here">
			...
			<img src="<?php echo base_url();?>bookmyplot_design/images/my_advitise_banner.png">
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
					<center>
                        ...
                        ?>
    <form id="signupForm" method="post"  action="<?php echo site_url('user/advertise_with_us/'); ?>" enctype="multipart/form-data">
