...
<div class="banner-about">
	<div class="container">
		<div class="banner-here">
			<img src="<?php echo base_url();?>bookmyplot_design/images/list-banner.jpg">
		</div>
	</div>
</div>
...
<?php $msg = $this->session->flashdata('message'); 
                        ...
                        ?>
    <form id="signupForm" method="post"  action="<?php echo site_url('user/add_list_your_property/'); ?>" enctype="multipart/form-data">
  
								<div class="form-group list_form_custom">
								  	<label for="location">Property Type</label><br/><br/>
									<select class="form-control" name="pro_type" required id="sel1">
									    <option>Plots</option>
						  		...
						  		<div class="form-group list_form_custom">
						    		...
						    		<input type="tel" name="phone" class="form-control" required  id="mobile" >
						  		</div>
						  		<div class="form-group list_form_custom">
						    		<label for="property-details">Property Details</label><br/><br/>
						    		<textarea rows="4" name="pro_details" required class="list-textarea"></textarea>
						  		</div>
						  		<div class="form-group list_form_custom">
						    		<label for="quot">Quote Your Best Price For The Group Purchase</label><br/><br/>
						    		<input type="text" name="best_price" required class="form-control" id="name" >
						  		</div>
						  		<div class="form-group list_form_custom">
...
<!-- 								    <input type="file" class="form-control-file" id="exampleInputFile"><br/>
 -->								    <input type="file" name="photograph" id="photograph"   style="left: -155.9375px; top: 3px;"><br/>
