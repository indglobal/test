...
<!--             <th width="5%">id</th>
 -->            <th width="10%">Type</th>
            ...
            <th width="40%">property details</th>
            <th width="10%">best price</th>
    ...
    <tbody>
       <div>
        ...
        <div style="height:10px;"></div> 
          <?php $i=1256;?>
            <?php foreach ($getListof_property as $key): 
            ?>
              <tr>

<!--                 <td><?php echo $key['id']; ?></td>
 -->                <td><?php echo $key['pro_type']; ?></td>
                <td><?php echo $key['location']; ?></td>
                <td><?php echo $key['name']; ?></td>
                <td><?php echo $key['email']; ?></td>
                <td><?php echo $key['phone']; ?></td>
                <td><?php echo $key['pro_details']; ?></td>
                <td><?php echo $key['best_price']; ?></td>
