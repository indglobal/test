		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="PropertyListingPage ListingBox"><!--Property Listing starts here-->
						<div class="row">
							<div class="col-md-4" style="padding:0;">
									...
									<div id="carousel-example-generic" class="carousel slide ListingImages" data-ride="carousel">
										<!-- Indicators -->
							...
							<div class="col-md-2 text-center" style="padding:0;border-right: 2px solid #ccc;">
								<div class="DeveloperContent">
									...
									<div class="builderLogo">
										<img src="images/builderlogo.jpg" width="80%">
									</div>
								</div>
								<div class="Intrested">
									<h5>INTRESTED</h5>
					...
					<div class="advertise">
						<img src="images/qa.jpg" width="100%">
					</div>
					...
					<div class="PropertyListingPage ListingBox"><!--Property Listing starts here-->
						<div class="row">
							<div class="col-md-4" style="padding:0;">
									...
									<div id="carousel-example-generic2" class="carousel slide ListingImages" data-ride="carousel">
										<!-- Indicators -->
											<!--  <ol class="carousel-indicators">
											    <li data-target="#carousel-example-generic" data-slide-to="0" class="active"></li>
											    <li data-target="#carousel-example-generic" data-slide-to="1"></li>
