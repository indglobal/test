...
<!-- 												    <img src="<?php echo base_url();?>bookmyplot_design/images/pro_3.jpg" alt="...">
 -->												    <img src="<?php echo base_url($value_images['property_images']);?>" alt="...">
				...
				<a href="<?php echo site_url('member/specific_builder/'.$dev_id);?>"><img src="<?php echo base_url();?>uploads/developer/<?php echo $search_data->photograph;?>" width="80%"></a>
									</div>
								</div>
								<div class="Intrested">
									<h5>INTRESTED</h5>
...
?>	                                    
                        ...
                        <input class="stars" type="radio" id="star4half" name="rating1" value="4.5" <?php if($j==4.5){?>checked<?php }?> />
                        <label class="half" for="star4half" title="Pretty good - 4.5 stars"></label>
                        <input class="stars" type="radio" id="star4" name="rating1" value="4" <?php if($j==4){?>checked<?php }?> />
                        <label class = "full" for="star4" title="Pretty good - 4 stars"></label>
                        <input class="stars" type="radio" id="star3half" name="rating1" value="3.5" <?php if($j==3.5){?>checked<?php }?>/>
                        <label class="half" for="star3half" title="Meh - 3.5 stars"></label>
                        <input class="stars" type="radio" id="star3" name="rating1" value="3" <?php if($j==3){?>checked<?php }?> />
                        <label class = "full" for="star3" title="Meh - 3 stars"></label>
                        <input class="stars" type="radio" id="star2half" name="rating1" value="2.5" <?php if($j==2.5){?>checked<?php }?>/>
                        <label class="half" for="star2half" title="Kinda bad - 2.5 stars"></label>
                        <input class="stars" type="radio" id="star2" name="rating1" value="2" <?php if($j==2){?>checked<?php }?>/>
                        <label class = "full" for="star2" title="Kinda bad - 2 stars"></label>
                        <input class="stars" type="radio" id="star1half" name="rating1" value="1.5" <?php if($j==1.5){?>checked<?php }?>/>
                        <label class="half" for="star1half" title="Meh - 1.5 stars"></label>
                        <input class="stars" type="radio" id="star1" name="rating1" value="1" <?php if($j==1){?>checked<?php }?>/>
                        <label class = "full" for="star1" title="Sucks big time - 1 star"></label>
                        <input class="stars" type="radio" id="starhalf" name="rating1" value="0.5" <?php if($j==0.5){?>checked<?php }?>/>
...
<!-- 												    <img src="<?php echo base_url();?>bookmyplot_design/images/pro_3.jpg" alt="...">
 -->												    <img src="<?php echo base_url($value_images['property_images']);?>" alt="...">
				...
				<div class="col-md-2 text-center" style="padding:0;">
								<div class="DeveloperContent">
									<h5>DEVELOPER<?php //echo $dev_id;?></h5>
									<div class="builderLogo">
					<img src="<?php echo base_url();?>uploads/developer/<?php echo $search_data->photograph;?>" width="80%">
                        ...
                        include_once(APPPATH.'libraries/modals.php'); ?>	                                    
                                     ...
                                     ?>
					<div class="Starrating1  text-left">
